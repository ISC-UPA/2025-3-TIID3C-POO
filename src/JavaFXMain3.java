...
public class JavaFXMain3 extends Application {

    public void start(Stage primaryStage) {

        AudioClip audio = new AudioClip(getClass().getResource("p1/Note5.wav").toString());
        Image image1 = new Image(getClass().getResource("p1/fan1.png").toString());
        Image image2 = new Image(getClass().getResource("p1/fan2.png").toString());
